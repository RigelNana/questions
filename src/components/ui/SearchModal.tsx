...
export function SearchModal({ isOpen, onClose }: SearchModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-start justify-center pt-[8vh] sm:pt-[15vh]">
      ...
      {/* Modal */}
      <div className="relative w-full max-w-lg mx-3 sm:mx-4 bg-[var(--color-notion-bg)] rounded-xl shadow-2xl border border-[var(--color-notion-border)] overflow-hidden animate-scale-in">
        {/* Search input */}
        <div className="flex items-center gap-3 px-4 py-3 border-b border-[var(--color-notion-border)]">
          <Search className="w-4 h-4 text-[var(--color-notion-text-secondary)] flex-shrink-0" />
          <input
            ref={inputRef}
            type="text"
            value={query}
            ...
            className="flex-1 text-sm bg-transparent text-[var(--color-notion-text)] placeholder:text-[var(--color-notion-text-secondary)] focus:outline-none"
          />
          <kbd className="text-[10px] text-[var(--color-notion-text-secondary)] bg-[var(--color-notion-bg-secondary)] border border-[var(--color-notion-border)] px-1.5 py-0.5 rounded">
            ESC
          </kbd>
        </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="text-xs text-[var(--color-notion-text-secondary)]">
